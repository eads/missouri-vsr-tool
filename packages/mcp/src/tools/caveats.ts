...
export const RESEARCH_PROMPT = [
  ...
  "- ASK THE AGENCY, AND THE AG'S PRESS OFFICE. For WHY an agency's stop reasons, rates, or types look the way they do, the answer is at the individual department — the Missouri AG's office declines to speculate on those patterns and directs reporters to the agencies. Put the trend you observed to the department directly. AG press office: press@ago.mo.gov (good for questions about the report, the ingest, or statewide context — but expect to be pointed back to the departments for agency-specific explanations).",
